...
cpo.start().then(async () => {
    ...
    if (regCheckRes.status !== 200 || regCheckText !== "CONNECTED") {
        ...
        console.log("CPO [DE CPO] already connected to OCN client at http://localhost:8080. Skipping")
    }
    ...
    if (clientURL === "") {
        ...
        console.log("CPO [DE CPO] written into OCN Registry with client http://localhost:8080")
    } else {
